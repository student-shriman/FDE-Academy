    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="inline-flex items-center gap-1 text-[11px] font-mono text-slate-500 bg-slate-100 px-2.5 py-0.5 rounded-full border border-slate-200">
        ...
        <p className="text-slate-600 text-sm sm:text-base max-w-4xl leading-relaxed">
          The entire 36-week body of knowledge. Check off completed topics using the interactive checkboxes <code>[✓]</code> 
      ...
      {progress && (
        <div className="bg-gradient-to-br from-slate-900 to-slate-950 text-white rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-xl space-y-5">
      ...
      <div className="sticky top-16 z-30 bg-slate-50/95 backdrop-blur-md pt-2 pb-4 border-b border-slate-200 space-y-3">
        <div className="flex flex-col sm:flex-row items-center gap-3">
          ...
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2.5 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:border-amber-500 focus:ring-1 focus:ring-amber-500 shadow-sm transition-all"
            />
            {searchQuery && (
              <button
            ...
            <button
              ...
              className={`px-2.5 py-1 rounded-md font-mono font-bold whitespace-nowrap transition-all hover:scale-105 active:scale-95 cursor-pointer ${
                p.phase_id === 'P0'
                  ...
                  : 'bg-white border border-slate-200 text-slate-700 hover:bg-amber-50 hover:text-amber-900 hover:border-amber-300'
              }`}
            >
              {p.phase_id}
            </button>
          ...
          displayedPhases.map((phase) => {
            ...
            return (
              <section 
                ...
                className="scroll-mt-40 space-y-5 bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow"
              >
                ...
                <div className="border-b border-slate-100 pb-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div className="sm:text-right shrink-0">
                    ...
                    <div className="w-32 h-2 bg-slate-100 rounded-full overflow-hidden mt-1 sm:ml-auto">
                      <div 
                  ...
                  {phase.topics.map((topic, tIdx) => {
                    ...
                    return (
                      <div 
                        ...
                        className="bg-slate-50/60 border border-slate-200/90 rounded-2xl p-5 space-y-4"
                      >
                        ...
                        <div className="flex items-center justify-between gap-3 border-b border-slate-200/60 pb-3">
                          ...
                          >
                            ...
                            <h3 className={`text-base sm:text-lg font-bold ${
                              hasFirstChapter 
                                ? 'text-slate-900 group-hover:text-amber-600 group-hover:underline' 
                                : 'text-slate-900'
                            }`}>
                              {topic.topic_name}
                            </h3>
                              ...
                              <div
                                ...
                                className={`p-3.5 rounded-xl border transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3 ${
                                  isDone
                                    ...
                                    : isClickable
                                    ? 'bg-white hover:bg-amber-50/70 border-slate-200/90 hover:border-amber-300 hover:shadow-sm'
                                    : 'bg-white hover:bg-slate-100/80 border-slate-200/70'
                                }`}
                              >
                                ...
                                <div className="flex items-center gap-3 self-end sm:self-center shrink-0 pl-8 sm:pl-0">
                                  ...
                                  {isClickable ? (
                                    <button 
                                      ...
                                      className="px-3 py-1.5 rounded-lg bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs flex items-center gap-1.5 shadow-sm transition-all hover:scale-105 active:scale-95 cursor-pointer"
                                    >
                                    ...
                                    <button
                                      ...
                                      className="px-2.5 py-1 rounded text-xs font-medium text-slate-500 bg-slate-100 hover:bg-slate-200 border border-slate-200 flex items-center gap-1 transition-colors cursor-pointer"
                                    >
      ...
      {activeModalSubtopic && (
        ...
        >
          <div 
            className="bg-white rounded-3xl max-w-2xl w-full p-6 sm:p-8 shadow-2xl border border-slate-200 space-y-6 relative max-h-[90vh] overflow-y-auto"
            ...
            <div className="space-y-4 text-sm text-slate-700">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="p-3 bg-white border border-slate-200 rounded-lg">
                  ...
                  <div className="text-sm font-bold text-slate-900 mt-0.5">{activeModalSubtopic.sub.hours || 2.0} Hours</div>
                </div>
                <div className="p-3 bg-white border border-slate-200 rounded-lg">
                  <div className="text-slate-400 font-semibold">Track</div>
                  <div className="text-sm font-bold text-slate-900 mt-0.5">{activeModalSubtopic.sub.track || "Core"}</div>
                </div>
              </div>
              ...
              {activeModalSubtopic.phase.deliverables?.[0] && (
                <div className="p-4 rounded-xl bg-amber-50/70 border border-amber-200 text-xs text-amber-950 space-y-1">
                  ...
                  <div>{activeModalSubtopic.phase.deliverables[0].project}</div>
