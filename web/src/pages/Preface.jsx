    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-16">
      ...
      <div className="border-b border-slate-200 pb-8 space-y-4">
        ...
        <h1 className="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight leading-tight">
          Preface: The Forward Deployed AI Architect
        </h1>
      ...
      <section className="space-y-5 text-slate-700 leading-relaxed">
        <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2.5">
          <span className="text-amber-500 font-mono text-xl">01.</span>
        ...
        <p>
          ...
          As Palantir framed it: <em className="text-slate-900 font-medium">"An FDE operates like the CTO of a high-stakes startup inside the enterprise client."</em>
        </p>
      ...
      <section className="space-y-6 text-slate-700 leading-relaxed">
        <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2.5">
          <span className="text-amber-500 font-mono text-xl">02.</span>
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2.5">
          <span className="text-amber-500 font-mono text-xl">03.</span>
        ...
        <div className="space-y-4">
          ...
          <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-start gap-4">
            ...
            <div className="space-y-1">
              <h3 className="text-base font-bold text-slate-900">Pillar 1: Uncompromising Technical Depth</h3>
          ...
          <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-start gap-4">
            ...
            <div className="space-y-1">
              <h3 className="text-base font-bold text-slate-900">Pillar 2: Customer Empathy & Active Discovery</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-start gap-4">
            ...
            <div className="space-y-1">
              <h3 className="text-base font-bold text-slate-900">Pillar 3: Rapid Prototyping Velocity (Speed as a Weapon)</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-start gap-4">
            ...
            <div className="space-y-1">
              <h3 className="text-base font-bold text-slate-900">Pillar 4: Production Ownership from Day One</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-start gap-4">
            ...
            <div className="space-y-1">
              <h3 className="text-base font-bold text-slate-900">Pillar 5: Measurable ROI & Executive Translation</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
      ...
      <section className="space-y-6 text-slate-700 leading-relaxed">
        <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2.5">
          <span className="text-amber-500 font-mono text-xl">04.</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-slate-900 text-white space-y-2 border border-slate-800">
            <div className="text-xs font-mono text-amber-400 font-bold">STAGE 01 &bull; 1–2 WEEKS</div>
          ...
          <div className="p-5 rounded-2xl bg-slate-900 text-white space-y-2 border border-slate-800">
            <div className="text-xs font-mono text-amber-400 font-bold">STAGE 02 &bull; 2–4 WEEKS</div>
          ...
          <div className="p-5 rounded-2xl bg-slate-900 text-white space-y-2 border border-slate-800">
            <div className="text-xs font-mono text-amber-400 font-bold">STAGE 03 &bull; 4–8 WEEKS</div>
          ...
          <div className="p-5 rounded-2xl bg-slate-900 text-white space-y-2 border border-slate-800">
            <div className="text-xs font-mono text-amber-400 font-bold">STAGE 04 &bull; PRODUCTION</div>
      ...
      <section className="space-y-6 text-slate-700 leading-relaxed">
        <h2 className="text-2xl font-bold text-slate-900 flex items-center gap-2.5">
          <span className="text-amber-500 font-mono text-xl">05.</span>
        ...
        <div className="space-y-4">
          <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <div className="text-xs font-bold text-amber-600 uppercase font-mono">Volume I &bull; Weeks 1–8</div>
              <div className="text-base font-bold text-slate-900 mt-0.5">Foundations, System Design & Enterprise Identity</div>
              <p className="text-xs text-slate-500 mt-1">Phases 0, 1, 2: Async Python, FastAPI, Distributed Queues, Microservices, OAuth2, Entra ID, RBAC/ABAC.</p>
            </div>
            <span className="text-xs font-bold px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 self-start sm:self-center">
              Phase 0 Complete
            </span>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <div className="text-xs font-bold text-slate-500 uppercase font-mono">Volume II &bull; Weeks 9–14</div>
              <div className="text-base font-bold text-slate-900 mt-0.5">Enterprise Data Architecture & Advanced RAG</div>
              <p className="text-xs text-slate-500 mt-1">Phases 3, 4: PostgreSQL internals, pgvector, hybrid search, ColPali multimodal parsing, HyDE, ACL-aware retrieval, RAGAS.</p>
            </div>
            <span className="text-xs font-semibold px-3 py-1 rounded-full bg-slate-100 text-slate-600 self-start sm:self-center">
              Roadmap
            </span>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <div className="text-xs font-bold text-slate-500 uppercase font-mono">Volume III &bull; Weeks 15–20</div>
              <div className="text-base font-bold text-slate-900 mt-0.5">Autonomous Agentic Systems & AI Security</div>
              <p className="text-xs text-slate-500 mt-1">Phases 5, 6: LangGraph state machines, Model Context Protocol (MCP), layered memory, OWASP LLM Top 10, STRIDE threat models.</p>
            </div>
            <span className="text-xs font-semibold px-3 py-1 rounded-full bg-slate-100 text-slate-600 self-start sm:self-center">
              Roadmap
            </span>
          ...
          <div className="p-5 rounded-2xl bg-white border border-slate-200 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <div className="text-xs font-bold text-slate-500 uppercase font-mono">Volume IV &bull; Weeks 21–36</div>
              <div className="text-base font-bold text-slate-900 mt-0.5">Cloud, Kubernetes, AI Performance & Capstone</div>
              <p className="text-xs text-slate-500 mt-1">Phases 7–12: Azure/AWS private clouds, Kubernetes & Helm, Terraform IaC, vLLM gateways, FinOps, OpenTelemetry & Executive Demo.</p>
            </div>
            <span className="text-xs font-semibold px-3 py-1 rounded-full bg-slate-100 text-slate-600 self-start sm:self-center">
              Roadmap
            </span>
      ...
      <section className="p-6 rounded-2xl bg-amber-50 border border-amber-200 text-amber-950 space-y-3">
        <h3 className="text-base font-bold flex items-center gap-2">
          <CheckCircle2 className="w-5 h-5 text-amber-600" />
          The Five Rules of the Forward Deployed Architect
        </h3>
        <ul className="text-xs sm:text-sm space-y-2 font-medium">
          <li><strong>Rule 1:</strong> The client does not care about your tech stack; they care about their business problem.</li>
          <li><strong>Rule 2:</strong> Code that never reaches production has exactly zero enterprise value.</li>
          <li><strong>Rule 3:</strong> Never optimize latency before verifying permission security.</li>
          <li><strong>Rule 4:</strong> Speed is achieved through thin vertical slices, not through skipped tests.</li>
          <li><strong>Rule 5:</strong> Speak fluent Python to your terminal, and fluent Economics to your stakeholders.</li>
        </ul>
      </section>
      ...
      <div className="pt-6 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div>
          <div className="font-bold text-slate-900">Ready to explore the Master Curriculum?</div>
          <div className="text-xs text-slate-500">Dive into all 13 phases or jump directly into Phase 0 chapters.</div>
        </div>

        <button
          onClick={() => onNavigate('contents')}
          className="px-6 py-3.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-sm flex items-center gap-2 shadow-lg shadow-amber-500/20 transition-all hover:scale-105 active:scale-95 cursor-pointer"
        >
